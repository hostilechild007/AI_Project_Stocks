...
class CriticNetwork(nn.Module):
    ...
    def __init__(self, input_dims, alpha, fc1_dims=300, fc2_dims=300, chkpt_dir=''):
        ...
        self.critic = nn.Sequential(nn.Linear(*input_dims, fc1_dims),  # *: to unpack list into separate elements; 1st layer
                                    ...
                                    # y = Wx + b; initializes random b w/ matrix out_features * 1 then W matrix out_features * in_features w/ random elements
                                    # nn.LeakyReLU(),
                                    # nn.LeakyReLU(),
